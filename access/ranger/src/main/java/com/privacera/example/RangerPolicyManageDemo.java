...
public class RangerPolicyManageDemo {

  private static final String RANGER_SERVICE = "privacera_s3";
  private static final String RANGER_SERVICE_TYPE = "s3";
  private static final String DEMO_POLICY_NAME = "DemoPolicy-manage-example-demo";
  ...
  public static void main(String[] args) throws RangerServiceException {
    ...
    RangerPolicy policyToCreate = generateRangerPolicy(RANGER_SERVICE_TYPE, RANGER_SERVICE, DEMO_POLICY_NAME,
        "bucket2025", "example-demo");
    RangerPolicy createdPolicy = rangerClient.createPolicy(policyToCreate);
    System.out.println("Created policy: id=" + createdPolicy.getId() + ", name=" + createdPolicy.getName());
